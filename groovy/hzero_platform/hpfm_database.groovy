...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_database.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_database") {
        ...
        createTable(tableName: "hpfm_database", remarks: "数据库") {
            column(name: "database_id", type: "bigint", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "public_flag", type: "tinyint",   defaultValue:"0",   remarks: "公共库标识")  {constraints(nullable:"false")}  
