...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_dashboard_layout.groovy') {
    ...
    changeSet(author: "xiaoyu.zhao@hand-china.com", id: "2019-11-05-hpfm_dashboard_layout") {
        addColumn(tableName: "hpfm_dashboard_layout"){
            if(helper.isOracle()){
                column(name: "card_id", type: "bigint(20)", defaultValue: "-1", remarks: "卡片id,hpfm_dashboard_card.id")  {constraints(nullable:"false")}
            } else {
                column(name: "card_id", type: "bigint(20)", remarks: "卡片id,hpfm_dashboard_card.id")  {constraints(nullable:"false")}
            }
        }
    ...
    changeSet(author: "xiaoyu.zhao@hand-china.com", id: "2020-04-29-hpfm_dashboard_layout") {
        ...
        modifyDataType(tableName: "hpfm_dashboard_layout", columnName: 'y', newDataType: "int(11)")
        modifyDataType(tableName: "hpfm_dashboard_layout", columnName: 'h', newDataType: "int(11)")
    }
}
