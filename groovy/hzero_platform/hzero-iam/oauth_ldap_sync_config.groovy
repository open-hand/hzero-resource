...
column(name: "ldap_sync_config_id", type: "bigint", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
...
column(name: "sync_type", type: "varchar(" + 30 * weight + ")",  remarks: "同步类型")  {constraints(nullable:"false")}  
column(name: "frequency", type: "varchar(" + 20 * weight + ")",  remarks: "同步频率,值集HIAM.LDAP_SYNC_FREQUENCY")  {constraints(nullable:"false")}  
...
column(name: "enabled_flag", type: "tinyint",   defaultValue:"0",   remarks: "是否开启Ldap自动同步，默认不开启")  {constraints(nullable:"false")}  
